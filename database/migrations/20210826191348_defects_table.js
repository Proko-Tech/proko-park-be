const defected_item_enum = ['KIOSK', 'BARRIER', 'SENSOR'];

const status_enum = ['REQUESTED', 'UNDER_REVIEW', 'RESOLVED'];
...
exports.up = function(knex) {
    return knex.schema.createTable('defects', (tbl) => {
        ...
        tbl.enum('defected_item', defected_item_enum, {
            useNative: true,
            enumName: 'defected_item_enum',
        });
