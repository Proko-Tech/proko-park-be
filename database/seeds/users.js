    ...
    return knex('users').del()
        .then(function() {
            ...
            return knex('users').insert([
                ...
                {id: 2, email: 'helloworld@gmail.com', phone_number: '5621231234', first_name:'Google', last_name:'User', password: '$2a$10$BqoGdXryg1ajOulvK1/.GOu8Dkqo1mHkF249acfL8QlCNHsAC6xZm', sign_up_type: 'GOOGLE'},
            ]);
        });
};
